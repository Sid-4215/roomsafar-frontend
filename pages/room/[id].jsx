...
export default function RoomDetails() {
  ...
  const seoTitle = `${room.type || "Room"} in ${area}, ${city} – ₹${room.rent?.toLocaleString(
    "en-IN"
  )} | Roomsafar`;

  const seoDesc = room.description
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  {room.isVerified && (
                    <span className="ml-2 px-3 py-1 bg-green-100 text-green-600 text-sm rounded-full inline-flex gap-1">
                      <FiCheck /> Verified
                    </span>
                  )}
